<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="MasterPayrollEarning.aspx.cs" Inherits="HRMS_Team4.Admin.MasterPayrollEarning" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-flex flex-wrap gy-2 justify-content-between my-4">
        ...
        <div class="mb-3 text-end">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#earningModal">
                Add Earning
                ...
                <asp:Repeater ID="rptEarning" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%# Eval("EarningsPercentage") %>%</td>
                            <td><%# Eval("DepartmentName") %></td>
                            <td><%# Eval("DesignationName") %></td>
                            <td>
                                <asp:LinkButton ID="btnEdit" runat="server"
                                    CssClass="me-2"
                                    CommandArgument='<%# Eval("EarningsId") %>'
                                ...
                                <asp:LinkButton ID="btnDelete" runat="server"
                                    ...
                                    OnClientClick="return confirm('Are you sure you want to delete this earning?');">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <asp:Label ID="Label1" runat="server" Text="Add Earning"></asp:Label>
                ...
                <div class="modal-body pb-0">
                    <asp:HiddenField ID="hfEarningsId" runat="server" />

                    <div class="mb-3">
                        <label class="form-label">Earning Type</label>
                        <asp:DropDownList ID="ddlEarningType" runat="server" CssClass="form-control"></asp:DropDownList>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Earnings Percentage</label>
                        <asp:TextBox ID="txtEarningsPercentage" runat="server"
                            CssClass="form-control"
                            placeholder="Enter Earnings Percentage" />
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button ID="btnAddEarning"
                        runat="server"
                        Text="Add Earning"
                        CssClass="btn btn-primary"
                        OnClick="btnAddEarning_Click" />
                </div>
