<%@ Page Title="Edit Admin Document" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeBehind="EditAdminDocName.aspx.cs" Inherits="HRMS_Team4.Admin.EditAdminDocName" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Edit Document Type</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="Default.aspx"><i class="ti ti-smart-home"></i></a></li>
                    <li class="breadcrumb-item">Admin</li>
                    <li class="breadcrumb-item"><a href="FetchAdminDocName.aspx">Admin Document List</a></li>
...
<asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btn me-2" style="background-color: #0d6efd; border-color: #0d6efd; color: white;" OnClick="btnUpdate_Click" />
                <a href="FetchAdminDocName.aspx" class="btn btn-secondary">Cancel</a>
            </div>
