<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="MasterPayrollDeductionType.aspx.cs" Inherits="HRMS_Team4.Admin.MasterPayrollDeductionType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-flex flex-wrap gy-2 justify-content-between my-4">
        ...
        <div class="mb-3 text-end">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#deductionTypeModal">
                Add Deduction Type
    ...
    <div class="card-body p-0">
        <table class="table dataTable" id="table">
            ...
            <tbody>
                <asp:Repeater ID="rptDeductionType" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td><%# Eval("DeductionTypeId") %></td>
                            <td><%# Eval("DeductionsName") %></td>
                            <td>
                                <asp:LinkButton ID="btnEdit" runat="server"
                                    CssClass="me-2"
                                    CommandArgument='<%# Eval("DeductionTypeId") %>'
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <asp:Label ID="Label1" runat="server" Text="Add Deduction Type"></asp:Label>
                ...
                <div class="modal-body pb-0">
                    <asp:HiddenField ID="hfDeductionTypeId" runat="server" />

                    <div class="mb-3">
                        <label class="form-label">Deduction Type Name</label>
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button ID="btnAddDeductionType"
                        runat="server"
                        Text="Add Deduction Type"
                        CssClass="btn btn-primary"
                        OnClick="btnAddDeductionType_Click" />
                </div>
