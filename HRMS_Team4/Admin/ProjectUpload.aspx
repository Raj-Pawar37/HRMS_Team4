<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ProjectUpload.aspx.cs" Inherits="HRMS_Team4.Admin.ProjectUpload" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        .dropdown-menu.checkbox-list-menu { max-height: 250px; overflow-y: auto; }
        .checkbox-list-menu ul { padding-left: 0; list-style: none; margin-bottom: 0; }
        .checkbox-list-menu li { padding: 4px 8px; }
        .checkbox-list-menu li:hover { background-color: #f8f9fa; }
        .checkbox-list-menu input[type="checkbox"] { margin-right: 8px; }
    </style>
</asp:Content>
