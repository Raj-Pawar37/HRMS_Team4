<%@ Page Title="Add Employee Document Name" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeBehind="AddEmployeeDocName.aspx.cs" Inherits="HRMS_Team4.Admin.AddEmployeeDocName" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Add Employee Document Type</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Employee Doc Name</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Add Employee Document Name</h5>
        </div>
        <div class="card-body">
            ...
            <div style="width: 40%;">
                ...
                <div class="form-group mb-3">
                    ...
                    <asp:TextBox ID="txtDocName" runat="server" CssClass="form-control" placeholder="e.g., Resume, PAN Card, Degree Certificate"></asp:TextBox>
